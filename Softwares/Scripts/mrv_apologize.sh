...
APOLOGIZE_TEXT="针对今晚%s%s周年生日会直播中出现的“延迟播出”“信源中断”等问题，Vsinger团队在此向大家致以诚挚歉意，非常抱歉在今天这个日子影响了各位的庆生心情，给大家带来了不好的体验，辜负了你们对%s的关爱，十分抱歉。
...
main() {
    printf "${APOLOGIZE_TEXT}" $1 $2 $1 $1 $2 $1 $3 $4 $5
}
